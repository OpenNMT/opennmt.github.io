...
* The [OpenNMT ecosystem](https://github.com/OpenNMT) includes tools and projects to cover the full NMT workflow:
  * [CTranslate2](https://github.com/OpenNMT/CTranslate2), a custom inference engine for OpenNMT models which explores model quantization and inference acceleration on CPU and GPU
